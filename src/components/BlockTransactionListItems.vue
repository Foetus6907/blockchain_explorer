...
<template>
  <div class="col q-mb-xl">
    ...
    <div class="row  justify-between items-center">
      ...
      <q-item-label class="text-grey-7 text-weight-medium col">{{ transactionFee }} ({{ transaction.size }} bytes)
      </q-item-label>
    </div>
    <div class="row q-col-gutter-lg justify-between items-center">
      <div class="col-sm-12 col-md-6">
        ...
        <q-item-label v-for="(input, key) in transaction.inputs" :key="key"
                      class="text-grey-9 flex justify-between items-center col-2">
      ...
      <div class="col-sm-12 col-md-6">
        ...
        <q-item-label v-for="(out, key) in transaction.out" :key="key"
                      class="text-grey-9 flex justify-between items-center col-2">
